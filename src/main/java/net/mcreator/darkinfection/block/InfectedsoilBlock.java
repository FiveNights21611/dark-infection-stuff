...
public class InfectedsoilBlock extends Block {
	public InfectedsoilBlock() {
		super(BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.STONE).sound(SoundType.GRAVEL).strength(1f, 10f)
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("a part of the dark infection it will spread forever if left unchecked"));
	}
