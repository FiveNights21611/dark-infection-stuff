...
public class GoToVoidCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher()
				.register(Commands.literal("govoid").requires(s -> s.hasPermission(4))
						.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(GoToVoidCommand::execute))
						.executes(GoToVoidCommand::execute));
	}
