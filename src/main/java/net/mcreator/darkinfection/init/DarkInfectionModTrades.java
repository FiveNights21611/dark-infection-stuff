...
public class DarkInfectionModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		...
		if (event.getType() == VillagerProfession.CLERIC) {
			...
			trades.get(5).add(new BasicItemListing(new ItemStack(Items.DIAMOND, 32), new ItemStack(Items.GOLDEN_APPLE, 4),
					new ItemStack(Items.ENCHANTED_GOLDEN_APPLE), 10, 20, 0f));
		}
	}
}
