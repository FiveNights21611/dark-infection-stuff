			...
			if (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == DarkInfectionModBlocks.INFECTEDSOIL
				...
				if (new Object() {
					...
					if (entity instanceof LivingEntity _entity)
						_entity.addEffect(new MobEffectInstance(DarkInfectionModMobEffects.DARKNESS, 10000, 0, (false), (false)));
				} else if (new Object() {
					public int getScore(String score, Entity _ent) {
						if (_ent instanceof Player _player) {
							Scoreboard _sc = _player.getScoreboard();
					...
					if (entity instanceof LivingEntity _entity)
						_entity.addEffect(new MobEffectInstance(DarkInfectionModMobEffects.DARKNESS, 10000, 2, (false), (false)));
					if (entity instanceof LivingEntity _entity)
				...
				if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(DarkInfectionModMobEffects.DARKNESS)
					...
					if (entity instanceof Player _player && !_player.level.isClientSide())
						_player.displayClientMessage(new TextComponent("Your homeland can no longer defend you..."), (false));
				}
			}
		}
	}
