...
public class VoidStoneCopperFortuneProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
				.isCorrectToolForDrops(Blocks.COPPER_ORE.defaultBlockState())) {
			if (EnchantmentHelper.getItemEnchantmentLevel(Enchantments.BLOCK_FORTUNE,
				...
				for (int index1 = 0; index1 < (int) (Mth.nextInt(new Random(), 3, 4)); index1++) {
					if (world instanceof Level _level && !_level.isClientSide()) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.RAW_COPPER));
						entityToSpawn.setPickUpDelay(0);
						_level.addFreshEntity(entityToSpawn);
				...
				for (int index2 = 0; index2 < (int) (Mth.nextInt(new Random(), 3, 5)); index2++) {
					if (world instanceof Level _level && !_level.isClientSide()) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.RAW_COPPER));
						entityToSpawn.setPickUpDelay(0);
						_level.addFreshEntity(entityToSpawn);
				...
				for (int index3 = 0; index3 < (int) (Mth.nextInt(new Random(), 3, 7)); index3++) {
					if (world instanceof Level _level && !_level.isClientSide()) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.RAW_COPPER));
						entityToSpawn.setPickUpDelay(0);
						_level.addFreshEntity(entityToSpawn);
				...
				for (int index4 = 0; index4 < (int) (Mth.nextInt(new Random(), 4, 9)); index4++) {
					if (world instanceof Level _level && !_level.isClientSide()) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.RAW_COPPER));
						entityToSpawn.setPickUpDelay(0);
						_level.addFreshEntity(entityToSpawn);
