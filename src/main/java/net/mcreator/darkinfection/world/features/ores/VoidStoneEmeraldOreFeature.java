...
public class VoidStoneEmeraldOreFeature extends OreFeature {
	...
	private static class VoidStoneEmeraldOreFeatureRuleTest extends RuleTest {
		static final VoidStoneEmeraldOreFeatureRuleTest INSTANCE = new VoidStoneEmeraldOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<VoidStoneEmeraldOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec
				.unit(() -> INSTANCE);
		private static final RuleTestType<VoidStoneEmeraldOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("dark_infection:void_stone_emerald_ore_match"), CUSTOM_MATCH);
		}
